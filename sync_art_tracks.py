...
def main():
    ...
    with sync_playwright() as p:
        ...
        # Collect both individual video links and full playlist/album container links
        ...
        for link in all_links:
            # If it's a playlist/album container link, grab its ID and open it to extract all tracks inside
            if "playlist?list=" in link or "list=" in link:
                ...
                try:
                    ...
                    # Scroll inside the playlist view to load all songs
                    for _ in range(5):
                        page.evaluate("window.scrollTo(0, document.documentElement.scrollHeight)")
